...
var sencha_utils = {core:{}};
sencha_utils.core.convert_map = function convert_map(b) {
  var c = cljs.core.js_obj.call(null), d = cljs.core.seq.call(null, b);
  if(cljs.core.truth_(d)) {
    for(b = cljs.core.first.call(null, d);;) {
      if(c[cljs.core.name.call(null, cljs.core.first.call(null, b))] = cljs.core.truth_(cljs.core.map_QMARK_.call(null, cljs.core.second.call(null, b))) ? convert_map.call(null, cljs.core.second.call(null, b)) : cljs.core.truth_(cljs.core.sequential_QMARK_.call(null, cljs.core.second.call(null, b))) ? sencha_utils.core.convert_array.call(null, cljs.core.second.call(null, b)) : cljs.core.truth_("\ufdd0'else") ? cljs.core.second.call(null, b) : null, b = cljs.core.next.call(null, d), cljs.core.truth_(b)) {
...
sencha_utils.core.convert_array = function convert_array(b) {
  return cljs.core.to_array.call(null, cljs.core.map.call(null, function(b) {
    return cljs.core.truth_(cljs.core.map_QMARK_.call(null, b)) ? sencha_utils.core.convert_map.call(null, b) : cljs.core.truth_(cljs.core.sequential_QMARK_.call(null, b)) ? convert_array.call(null, b) : cljs.core.truth_("\ufdd0'else") ? b : null
  }, b))
};
sencha_utils.core.to_config = function(a) {
  return sencha_utils.core.convert_map.call(null, a)
};
var extjs4 = {core:{}};
clojure.browser.repl.connect.call(null, "http://localhost:9000/repl");
extjs4.core.ext = Ext;
extjs4.core.create = function(a, b) {
  return extjs4.core.ext.create(a, sencha_utils.core.to_config.call(null, b))
};
extjs4.core.application = function(a, b) {
  return extjs4.core.ext.application(sencha_utils.core.to_config.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'launch"], {"\ufdd0'name":a, "\ufdd0'launch":b})))
};
extjs4.core.define = function(a, b) {
  return extjs4.core.ext.define(a, sencha_utils.core.to_config.call(null, b))
};
var cljs_chat = {core:{}};
cljs_chat.cometd = {};
...
extjs4.core.ext.onReady(function() {
  ...
  return cljs_chat.cometd.cometd_var.addListener("/meta/connect", function() {
    return cljs.core.truth_(cljs.core.not.call(null, cljs.core.deref.call(null, cljs_chat.cometd.connected))) ? cljs.core.swap_BANG_.call(null, cljs_chat.cometd.connected, function() {
      return true
    }) : null
  })
});
